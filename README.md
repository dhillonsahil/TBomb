...
git clone https://github.com/dhillonsahil/bombattack.git
cd TBomb
./TBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of BombAttack are published in [Github](https://github.com/dhillonsahil/bombattack.git) and [PyPi](https://pypi.org/project/tbomb)
##
